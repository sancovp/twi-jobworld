#!/usr/bin/env python3
"""
Jobworld conversation registry — per-agent MULTI-conversation store with a rolling default.
...
On-disk shape (a single JSON file; default ~/.jobworld/convos.json, survives restarts)::
...
def _default_registry_path() -> Path:
    ...
    return Path.home() / ".jobworld" / "convos.json"
